    ...
    <div className="h-[40rem] w-full rounded-md flex md:items-center md:justify-center antialiased bg-grid-white/[0.02] relative overflow-hidden">
      ...
      <div className=" p-4 max-w-7xl  mx-auto relative z-10  w-full pt-20 md:pt-0">
        ...
        <p className="mt-4 font-normal text-base text-neutral-300 max-w-lg text-center mx-auto">
          Edu AI is a great way to draw attention to a specific part
          of the childrens who's age is 8-16. Here, we are drawing the attention towards the learning  of legal rights 
